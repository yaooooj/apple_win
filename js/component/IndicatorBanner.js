...
const Banner_REF = 'Banner';
const INDICATOR_REF = 'indicator';
export default class IndicatorBanner extends Component {
    static propTypes = {
        ...Banner.propTypes,
    ...
    setPage (selectedPage) {
        this.refs[Banner_REF].setPage(selectedPage)
    }

    setPageWithoutAnimation (selectedPage) {
        this.refs[Banner_REF].setPageWithoutAnimation(selectedPage)
    }
}
